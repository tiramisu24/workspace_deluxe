...
function Workspace(url, auth, auth_cb) {
    ...
    this.list_queries = function (_callback, _errorCallback) {
    return json_call_ajax("Workspace.list_queries",
        [], 1, _callback, _errorCallback);
};

    this.list_queries_async = function (_callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.list_queries", [], 1, _callback, _error_callback);
    };

    this.run_query = function (queryname, parameters, _callback, _errorCallback) {
    return json_call_ajax("Workspace.run_query",
        [queryname, parameters], 1, _callback, _errorCallback);
};

    this.run_query_async = function (queryname, parameters, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.run_query", [queryname, parameters], 1, _callback, _error_callback);
    };
